...
class Request extends GuzzleClient
{
    ...
    {
        // SSL: use a system CA bundle if one can be found, otherwise fall back to
        // disabling peer verification — mirrors the same defensive pattern used
        // for the Telr payment gateway cURL calls in IDLController.
